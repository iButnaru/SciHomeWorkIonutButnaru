...
public class DataBaseTest {
    ...
    public void insertDataTest() throws SQLException {
        ...
        try {
            ...
            preparedStatement1.setString(3, "King size");
            preparedStatement1.setInt(4, 2);
            preparedStatement1.setString(5, "Comfortable and welcoming.");
            ...
            while (rs1.next()) {
                ...
                assertEquals("Hotel", rs1.getString(2));
                assertEquals("King size", rs1.getString(3));
                assertEquals(2, rs1.getInt(4));
                assertEquals("Comfortable and welcoming.", rs1.getString(5));
            ...
            preparedStatementt.setInt(2, 150);
            preparedStatementt.setString(3, "autumn");
            ...
            while (rs.next()) {
                ...
                assertEquals("autumn", rs.getString(3));
    ...
    public void selectFromTableTest() throws SQLException {
        ...
        try {
            ...
            try {
                ...
                ResultSet rs = prd.executeQuery();
                final Logger LOGGER = Logger.getLogger(DataBaseTest.class.getName());
            ...
            final Logger LOGGER = Logger.getLogger(DataBaseTest.class.getName());
            PreparedStatement prd1 = connection.prepareStatement("select * from room_fair as rf,accomodation as a,accomodation_fair_relation as afr where rf.id=afr.id_room_fair and a.id=afr.id_accomodation and rf.value=100");
            ResultSet rs1 = prd1.executeQuery();
